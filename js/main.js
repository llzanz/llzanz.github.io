...
function ourplan(X,Y){
    ...
    plan.call(this,1,X,Y,66,80,0,660,0,"images/bz.gif",imagesrc);
...
function start(){
    ...
    if(mark==20){
        ...
        //大飞机
        if(mark1==20){
            enemys.push(new enemy(12,57,210,110,164,30000,540,1,"images/dd.gif","images/enemy2_fly_1.png"));
            mark1=0;
        }
        //小飞机
        else{
            enemys.push(new enemy(1,19,286,34,24,1000,360,random(1,4),"images/xx.gif","images/enemy1_fly_1.png"));
        }
        mark=0;
    }
